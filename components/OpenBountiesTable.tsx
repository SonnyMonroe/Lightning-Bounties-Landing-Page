            ...
            {displayedBounties.map((bounty, index) => {
              ...
              return (
                <tr 
                  ...
                  className="hover:bg-slate-50 dark:hover:bg-white/5 transition-all duration-200 group cursor-pointer relative border-l-4 border-transparent hover:border-orange-500 dark:hover:border-orange-400 hover:shadow-md dark:hover:shadow-black/20"
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => {
                ...
                >
                  ...
                  <td className="px-4 sm:px-6 py-4">
                    <div className="font-bold text-slate-900 dark:text-white text-base group-hover:text-cyan-700 dark:group-hover:text-mv-cyan transition-colors font-display tracking-wide uppercase line-clamp-2 group-hover:translate-x-1 duration-200">
                      {bounty.title}
                    </div>
                    ...
                    <div className="flex sm:hidden items-center gap-2 text-slate-500 dark:text-slate-400 font-mono text-xs mt-1">
                      <a 
                        ...
                        className="flex items-center gap-1 hover:text-cyan-600 dark:hover:text-mv-cyan underline decoration-slate-400/50"
                      >
                  ...
                  <td className="px-4 sm:px-6 py-4 hidden sm:table-cell whitespace-nowrap">
                    <a 
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="inline-flex items-center gap-2 text-slate-500 dark:text-slate-400 font-mono text-xs hover:text-cyan-600 dark:hover:text-mv-cyan transition-colors hover:underline decoration-cyan-500/30 underline-offset-4"
                    >
                  ...
                  <td className="px-4 sm:px-6 py-4 text-right whitespace-nowrap">
                    <div className={`inline-flex items-center gap-1 font-mono font-bold text-sm sm:text-base px-2 sm:px-3 py-1.5 rounded-sm border shadow-sm transition-all duration-300 group-hover:scale-105 origin-right ${
                        currency === 'SATS' 
                            ? 'text-cyan-700 dark:text-mv-cyan bg-cyan-50 dark:bg-mv-cyan/5 border-cyan-200 dark:border-mv-cyan/20 dark:shadow-[0_0_10px_rgba(0,240,255,0.1)]' 
